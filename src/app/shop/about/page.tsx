        ...
        <div className="relative z-10">
          ...
          <div className="space-y-10 text-foreground">
            ...
            <section className="space-y-4 group animate-fade-in-up delay-100">
              ...
              <div className="pl-5 ml-0.5 border-l border-border py-1">
                <p className="leading-relaxed text-lg">
                  การเติมเงินเพื่อสนับสนุนเซิร์ฟเวอร์ถือเป็น <span className="text-red-500 font-bold border-b border-red-500/30 pb-0.5">ความยินยอมโดยสมัครใจของผู้เล่น</span> 
                ...
                <ul className="space-y-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="leading-relaxed">
                      <strong className="text-foreground font-semibold">ไอเทม กาชา หรือสกิน</strong> ที่ได้รับจากการสนับสนุน <br/>
                      <span className="text-red-500 font-medium">ไม่สามารถเปลี่ยนเป็นเงินสด หรือโอนคืนได้ในทุกกรณี</span>
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="inline-block w-1.5 h-1.5 rounded-full bg-red-500 mt-2.5 flex-shrink-0" />
                    <span className="leading-relaxed">
                      <strong className="text-foreground font-semibold">ไอเทมประเภทใช้งาน</strong> (ที่ไม่ใช่สกินหรือของตกแต่งถาวร) <br/>
                      สามารถซื้อและใช้ได้เฉพาะภายใน <span className="text-red-500 font-bold px-2 py-0.5 bg-red-500/10 rounded border border-red-500/20">ซีซั่นปัจจุบัน</span> เท่านั้น
                    </span>
                  </li>
                </ul>
              </div>
            ...
            <section className="space-y-4 group animate-fade-in-up delay-300">
              ...
              <div className="bg-red-500/10 border-l-4 border-l-red-600 border-y border-r border-red-500/20 rounded-r-lg p-5 ml-1">
                <p className="text-foreground font-medium leading-relaxed">
                  ในกรณีที่มีการ <span className="text-red-500 font-bold">ปิดปรับปรุงระบบ</span>, <span className="text-red-500 font-bold">การเริ่มต้นซีซั่นใหม่</span> หรือ <span className="text-red-500 font-bold">การสิ้นสุดการให้บริการเซิร์ฟเวอร์ในอนาคต</span>
                </p>
                <div className="mt-3 flex items-center gap-2 text-red-500 font-bold text-lg">
